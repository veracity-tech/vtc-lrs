...
!(function($) {
    ...
    (c.VERSION = '2.4.0'),
        (c.KEYMAP = { 13: 'Enter', 27: 'Escape', 39: 'ArrowRight', 40: 'ArrowDown' }),
        ...
        (c.prototype.init = function(a, b) {
            ...
            this.options.selector
                ? this.$element.on(this.options.trigger, this.options.selector, function(a, b) {
                ...
                this.options._isDelegate ||
                    ...
                    this.$element.on('shown.bs.confirmation', function(a) {
                        c.options.popout &&
                            !c.eventBody &&
                            (c.eventBody = $('body').on('click.bs.confirmation.' + c.uid, function(a) {
        ...
        (c.prototype.setContent = function() {
            ...
            if (
                ...
                c
                    ...
                    .detach()
                    .end()
                    [this.options.html ? ('string' == typeof e ? 'html' : 'append') : 'text'](e),
