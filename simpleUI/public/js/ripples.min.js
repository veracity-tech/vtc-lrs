        ...
        (e.prototype.rippleOn = function(a, b) {
            ...
            g.hasTransitionSupport()
                ? b
                      ...
                      .data('animating', 'on')
                      .data('mousedown', 'on')
                : b.animate({ width: 2 * Math.max(a.outerWidth(), a.outerHeight()), height: 2 * Math.max(a.outerWidth(), a.outerHeight()), 'margin-left': -1 * Math.max(a.outerWidth(), a.outerHeight()), 'margin-top': -1 * Math.max(a.outerWidth(), a.outerHeight()), opacity: 0.2 }, 500, function() {
